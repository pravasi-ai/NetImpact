...
def analyze(device: str, proposed: str, detailed: bool, format: str):
    ...
    try:
        ...
        proposed_config = config_loader.load_proposed_config(proposed)
        if not proposed_config:
            console.print(f"[red]Error: Could not load proposed config from {proposed}[/red]")
            return
